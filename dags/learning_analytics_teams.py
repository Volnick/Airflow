...
import extract_operators, load_operators, transform_operators
import clean_operators
...
load_channel_messages = PythonOperator(
    ...
    op_kwargs={
        ...
        'index_elements': ['id'],
        'upsert_cols': [
            'group_id', 'message_type', 'subject', 'summary',
...
#Nick Volkmann
extract_channel_messages_replies = PythonOperator(
     task_id='extract_channel_messages_replies',
     python_callable=extract_operators.generic_extract_from_dataframe_args,
     op_kwargs={
         'graph_endpoint': '/beta/teams/{group_id}/channels/{id}/messages/{message_id}/replies/{replies_id}',
         'input_fp': merge_channels.op_kwargs['output_fp'],
         'output_fp_template': base_path + 'json/channel_messages_replies/{group_id}/{id}.json',
         'max_parallel': 1
     }
 )
